...
type AddEventRequest struct {
	...
	Url       string `protobuf:"bytes,2,opt,name=url,proto3" json:"url,omitempty"`                     // URL, связанный с событием
	Timestamp string `protobuf:"bytes,3,opt,name=timestamp,proto3" json:"timestamp,omitempty"`         // Временная метка события в формате ISO8601
}
...
func (x *AddEventRequest) GetUrl() string {
	if x != nil {
		return x.Url
	}
	return ""
...
func (x *AddEventRequest) GetTimestamp() string {
	if x != nil {
		return x.Timestamp
	}
	return ""
...
var file_proto_event_event_proto_rawDesc = []byte{
	...
	0x09, 0x74, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x22, 0x46, 0x0a, 0x10, 0x41, 0x64,
	...
	0x67, 0x65, 0x32, 0x65, 0x0a, 0x0c, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x53, 0x65, 0x72, 0x76, 0x69,
	0x63, 0x65, 0x12, 0x55, 0x0a, 0x08, 0x41, 0x64, 0x64, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x12, 0x16,
	...
	0x61, 0x64, 0x64, 0x5f, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x42, 0x08, 0x5a, 0x06, 0x2f, 0x65, 0x76,
...
var file_proto_event_event_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
...
var file_proto_event_event_proto_depIdxs = []int32{
	0, // 0: event.EventService.AddEvent:input_type -> event.AddEventRequest
	1, // 1: event.EventService.AddEvent:output_type -> event.AddEventResponse
...
func file_proto_event_event_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_proto_event_event_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_proto_event_event_proto_msgTypes[1].Exporter = func(v any, i int) any {
